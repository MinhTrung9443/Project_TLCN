...
const SettingTaskTypePage = () => { // Tên component cho trang Global Settings
    ...
    return (
        <div className="settings-list-container">
             <div className="header-actions">
                <h3>Manage Global Task Types</h3>
                <button className="btn btn-primary" onClick={() => handleOpenModal()}>
                    + Add Task Type
                </button>
            </div>

            <div className="settings-list-body"> {/* Bọc trong một div để có style nhất quán */}
                 {taskTypes.map(tt => {
                    ...
                    return (
                        <div className="settings-list-row" key={tt._id}>
                            ...
                            <div className="row-col col-project">
                                {tt.projectId ? tt.projectId.name : <span className="default-badge">Default</span>}
                            </div>
