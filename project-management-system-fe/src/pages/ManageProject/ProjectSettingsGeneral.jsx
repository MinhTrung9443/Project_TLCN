          ...
          <div className="pt-4 border-t border-neutral-200">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg bg-neutral-50">
                <div>
                  <p className="font-medium text-neutral-800">Liên kết tài khoản GitHub</p>
                  <p className="text-sm text-neutral-500">
                    Cho phép tự động cập nhật task khi có commit trên GitHub
                  </p>
                </div>
              ...
              <div className="p-4 border border-neutral-200 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <p className="font-medium text-neutral-800">Liên kết Repository cho Project</p>
                  <Button type="button" onClick={fetchGithubRepos} disabled={isLoadingRepos} size="sm" variant="secondary">
                    {isLoadingRepos ? "Đang tải..." : "Tải danh sách Repos"}
                  </Button>
                </div>

                {isGithubConnected && githubRepos.length > 0 && (
                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-neutral-700">Chọn Repository</label>
                    <select
                    ...
                    >
                      <option value="">-- Không liên kết/Hủy liên kết --</option>
                ...
                {selectedRepoStr && selectedRepoStr !== "" && (
                  <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800 flex items-center gap-2">
                    ...
                    Đã chọn: {JSON.parse(selectedRepoStr).name || JSON.parse(selectedRepoStr).full_name}
                  </div>
                )}
              </div>
            </div>
