    ...
    const handleEmojiClick = async (emojiObject) => {
        try {
            ...
            const existingReactionIndex = comment.reactions.findIndex(
                r => r.userId === currentUser._id && r.emoji === emojiObject.emoji
            );
                ...
                <div className="comment-body">
                    ...
                    <div className="comment-footer">
                        <div className="comment-reactions">
                            ...
                            <button className="add-reaction-btn" onClick={() => setShowEmojiPicker(!showEmojiPicker)} title="Add reaction">+</button>
                        </div>
                        <div className="comment-actions">
                            <button onClick={() => setActiveReplyId(isReplying ? null : comment._id)}>
