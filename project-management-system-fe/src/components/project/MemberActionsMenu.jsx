...
const MemberActionsMenu = ({ item, onRemoveMember, onRemoveTeam, onChangeRole, onAddMemberToTeam, onRemoveMemberFromTeam, isTeamMember = false }) => {
    ...
    if (item.isTeam && item.team) {
      return (
        <>
          ...
          >
            <span className="material-symbols-outlined menu-icon">person_add</span>
            <span className="menu-text">Add Member to Team</span>
          </li>
          <li
            className="danger"
            onClick={() => {
          ...
          >
            <span className="material-symbols-outlined menu-icon">delete</span>
            <span className="menu-text">Remove Team</span>
          </li>
        </>
      );
    } else {
      return (
        <>
          {item.role !== "LEADER" && (
            ...
            >
              <span className="material-symbols-outlined menu-icon">workspace_premium</span>
              <span className="menu-text">Set as Leader</span>
            </li>
          )}
          {item.role !== "MEMBER" && (
            <li
            ...
            >
              <span className="material-symbols-outlined menu-icon">badge</span>
              <span className="menu-text">Set as Member</span>
            </li>
          )}
          ...
          {isTeamMember && item.role !== "LEADER" && (
            ...
            >
              <span className="material-symbols-outlined menu-icon">person_remove</span>
              <span className="menu-text">Remove from Team</span>
            </li>
          )}
          ...
          >
            <span className="material-symbols-outlined menu-icon">block</span>
            <span className="menu-text">Remove from Project</span>
          </li>
        </>
      );
    }
  ...
  return (
    <div className="actions-menu-container">
      <button ref={buttonRef} onClick={handleToggle} className="actions-btn" aria-haspopup="menu" aria-expanded={isOpen}>
